...
// Orden de piezas en la tabla: I=0, O=1, T=2, S=3, Z=4, J=5, L=6
// (debe coincidir con el orden del enum PieceType en Types.h)
//
// NOTA para la defensa: S y Z tienen solo 2 formas visualmente
// distintas (rotar 180 grados las deja iguales). Aun asi se guardan
// las 4 orientaciones tal como pide el enunciado ("4 orientaciones
// precalculadas de cada pieza"); las orientaciones 2 y 3 repiten la
// forma de 0 y 1 respectivamente. Esto es un comportamiento estandar
// de Tetris y se documenta explicitamente aqui.
...
const int Tetromino::TABLA_FORMAS[7][4][4][2] = {
    ...
    // O (las 4 orientaciones son identicas: no tiene sentido rotar un cuadrado)
    {
        {{0,1},{0,2},{1,1},{1,2}},
        {{0,1},{0,2},{1,1},{1,2}},
        {{0,1},{0,2},{1,1},{1,2}},
